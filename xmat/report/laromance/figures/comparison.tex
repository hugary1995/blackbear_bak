\begin{figure}[htb!]
  ...
  \begin{subfigure}[b]{0.45\textwidth}
    \centering
    \tikzsetnextfilenamesafe{laromance/comparison/metal_creep_strain}
    \begin{tikzpicture}
      \begin{axis}[
          colormap/jet,
  ...
  \begin{subfigure}[b]{0.45\textwidth}
    \centering
    \tikzsetnextfilenamesafe{laromance/comparison/oxide_creep_strain}
    \begin{tikzpicture}
      \begin{axis}[
          colormap/jet,
          cycle list={[of colormap,samples of colormap=3]},
  ...
  \begin{subfigure}[b]{0.45\textwidth}
    \centering
    \tikzsetnextfilenamesafe{laromance/comparison/oxide_stress}
    \begin{tikzpicture}
      \begin{axis}[
          colormap/jet,
          cycle list={[of colormap,samples of colormap=3]},
