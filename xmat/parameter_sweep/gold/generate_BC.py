...
# all time in seconds
full_duration = 23 * 3600
partial_duration = 1 * 3600
shutdown_duration = 24 * 3600
fp_transition = 3 * 3600
pf_transition = 3 * 3600
...
total_duration = 5 * 12 * 30 * 24 * 3600
