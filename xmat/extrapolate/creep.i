...
[Materials]
  ...
  [creep]
    ...
    stress_input_window_failure = EXTRAPOLATE
    temperature_input_window_failure = EXTRAPOLATE
    cell_input_window_failure = ERROR
    wall_input_window_failure = ERROR
    environment_input_window_failure = ERROR
    environmental_factor = 5.13e-2
    initial_cell_dislocation_density = 2.3e12
    initial_wall_dislocation_density = 1.41e13
    verbose = false
  []
  [stress_metal]
